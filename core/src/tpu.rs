...
impl Tpu {
    ...
    pub fn new(
        ...
        let (udp_packet_sender, udp_packet_receiver) = solana_streamer::streamer::packet_batch_channel(100_000, 10_000);
        let (udp_vote_packet_sender, udp_vote_packet_receiver) =
            solana_streamer::streamer::packet_batch_channel(100_000, 10_000);
        ...
        let (quic_packet_sender, quic_packet_receiver) = solana_streamer::streamer::packet_batch_channel(100_000, 10_000);
        ...
        let (verified_sender, verified_receiver) = solana_streamer::streamer::packet_batch_channel(10_000, 10_000);
        ...
        let (verified_tpu_vote_packets_sender, verified_tpu_vote_packets_receiver) = solana_streamer::streamer::packet_batch_channel(10_000, 10_000);
        ...
        let (verified_gossip_vote_packets_sender, verified_gossip_vote_packets_receiver) =
            solana_streamer::streamer::packet_batch_channel(10_000, 10_000);
